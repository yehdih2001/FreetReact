...
@RestController
@RequestMapping("/api/freet-react-kafka")
public class FreetReactKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FreetReactKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FreetReactKafkaResource(KafkaProperties kafkaProperties) {
